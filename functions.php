...
function my_script_init()
  { // WordPressに含まれているjquery.jsを読み込まない
    ...
    wp_enqueue_script( 'quicklink', '//cdnjs.cloudflare.com/ajax/libs/quicklink/2.0.0-alpha/quicklink.umd.js', "", "1.0.1", true);
    wp_enqueue_script( 'yt-js', get_template_directory_uri() . '/js/yt.js', array( 'jquery' ), filemtime( get_template_directory().'/js/yt.js' ), true );
    wp_enqueue_script( 'btn-js', get_template_directory_uri() . '/js/btn.js', array( 'jquery' ), filemtime( get_template_directory().'/js/btn.js' ), true );
    wp_enqueue_script( 'anim-js', get_template_directory_uri() . '/js/anim.js', array('jquery'), filemtime( get_template_directory().'/js/anim.js' ), true );
